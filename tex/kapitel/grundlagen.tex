...
Aufgrund der unterschiedlichen Einsatzbereiche von Industrie 4.0 Systemen, unterscheiden sich auch dementsprechend deren Anforderungen. Um eine sichere Kommunikation in diesen Umgebungen bereitzustellen dienen die Grundprinzipien der sicheren Kommunikation. Die Referenzmodelle \ac{RAMI4.0} und \ac{IIRA} beschreiben grundsätzlich drei Anforderungen an den Übertragungskanal: Sicherheit, Verfügbarkeit und Dienstequalität \cite{BMWiNeCon2016}.

Um eine Analyse der Netzwerkkommunikation in Industrie 4.0 Umgebungen durchführen zu können werden im folgenden die Grundprinzipien der sicheren Kommunikation sowie die in den Referenzmodellen \ac{RAMI4.0} und \ac{IIRA} Anforderungen beschrieben.
...
\subsection{Anforderungen der Referenzmodelle \ac{RAMI4.0} und \ac{IIRA}}
...
\subsubsection{Dienstequalität (\ac{QoS})}
TODO - \ac{QoS}
