...
Das \ac{IoT} ist ein wesentlicher Bestandteil der Industrie 4.0, welche Netzwerke aus Systemen, Daten und Dienstleistungen herstellt, in denen diese Komponenten miteinander kommunizieren. Für die Kommunikation haben sich, je nach Anforderungen, verschiedene Protokolle, wie \ac{HTTP} und \ac{XMPP} etabliert. Jedes dieser Protokolle besitzt für spezifische Anforderungen wie Skalierbarkeit, vorhandene Ressourcen, Echtzeitkommunikation oder Sicherheit Vor- und Nachteile. 

TODO - \ac{IIoT}
Im \ac{IIoT} stellt vorallem die M2M-Kommunikation eine wichtige Rolle dar.
Das Protokoll \ac{CoAP} wird im Rahmen des \ac{IETF} im RFC 7252\footnote{Link - https://tools.ietf.org/html/rfc7252} standadisiert.
\ac{CoAP}, \ac{MQTT}
und erfüllt die Bedinungen für \ac{M2M} Kommunikation in 
