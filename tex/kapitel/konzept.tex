...
\section{Abgrenzung}
Da die Implementierung zur Darstellung der Schwachstellen im Bereich der Netzwerksicherheit im in \autoref{Grundlagen:Testsystem} beschriebenen Testsystem durchgeführt werden soll, liegt der Schwerpunkt der Analyse auf dem Protokoll \ac{OPC UA} und dessen Bestandteilen. Der folgende Teil beinhaltet eine Beschreibung der Risikofaktoren in Industrie 4.0 Umgebungen und die Analyse gegebener Übertragungsmedien und Infrastrukturen sowie der im Testsystem verwendeten High Level Protokolle ( Application- und Transport-Layer ) des TCP/IP Referenzmodells mit Bezug auf ihre Anforderungen im Bereich der Netzwerksicherheit. 