...
\subsection{CoAP Client/CoAP Server}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=15cm]{dhcpdnsseq}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=15cm]{dnsrekseq}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=15cm]{dnsitseq}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=15cm]{coapseq}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=15cm]{coapMani}
