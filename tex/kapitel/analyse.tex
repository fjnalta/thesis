...
Im folgenden Abschnitt werden anhand des Testsystems \cite{Weber2018} Auswirkungen von Manipulation des Netzwerks auf der Netzzugangsschicht in zwei Anwendungsszenarien dargestellt und Möglichkeiten des Schutz gegen diese Angriffe beschrieben.

\subsubsection{Anwendungsszenario - \ac{ARP} Spoofing}
TODO - verfälschter Ethernetrahmen -> MAC Manipulation - MitM
TODO - Schutz durch statische Tabellen, \ac{IDS}

\subsubsection{Anwendungsszenario - DHCP Spoofing/Snooping}
